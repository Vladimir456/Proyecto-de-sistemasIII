...
<body>
    ...
    <div style="margin-left:40px">
        <h4>Registar Horas Salida</h4>
        <hr class="divisor-linea" style="margin-bottom: 25px;">

        <form action="horasalida.php" method="POST">
...
<div class="form-group">
              ...
              <input class="form-control" name="fecha" type="text"  value="<?php echo date("m/d/Y h:i:s A"); ?>" placeholder="Ingresar Hora Salida"  required/>
  </div>
        ...
        <div style="margin-top:10px">
            <table class="table" border="1px">
                ...
                <tbody>
                    ...
                    $sql = "SELECT registroi.Id_Empleado,registro.Hora_ingreso ,registroi.Hora_salida 
                                FROM registroi
                                INNER JOIN registro
